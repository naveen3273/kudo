        ...
        <div className="p-3">
            ...
            <form method="post" onSubmit={e => !confirm('Are you sure?') ? e.preventDefault() : true}>
                ...
                <div className="w-full text-right mt-4">
                    <button className="rounded-xl bg-yellow-300 font-semibold text-blue-600 px-16 py-2 transition duration-300 ease-in-out hover:bg-yellow-400 hover:-translate-y-1" name="_action" value="Save">
                    Save
                    </button>
                </div>
